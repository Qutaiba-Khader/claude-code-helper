...
(function (global) {
  ...
  var SETTINGS = [
    ...
    { key: 'env.CLAUDE_CODE_ENABLE_PROMPT_SUGGESTION', type: 'string', def: null,
      group: 'Interface', values: ['false', 'true'],
      desc: 'The greyed-out suggestion in the prompt. Set to false to turn it off. It is skipped anyway on the first turn, in plan mode, and when the prompt cache is cold.',
      example: 'false' },
  ...
  var ENV_VARS = [
    ...
    { name: 'CLAUDE_CODE_ENABLE_PROMPT_SUGGESTION', desc: 'Set to false to stop the greyed-out prompt suggestions.' },
